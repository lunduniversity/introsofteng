...
The purchasing department will keep a close eye on the engineering efforts of the supplier. After all, this is the supplier's last chance to deliver the robot that has been specified in the SRS. At the same time, your domain expert will analyze the Robot Market to make a final decision of your Robot team composition, i.e., \textbf{optimizing the Rumble strategy}. After Sprint 3, your domain expert will submit the final purchase orders to the regulatory body.
