...
To support Sprint 1, the following sessions are schedueled:
\begin{itemize}
\item Lecture 1: Robocode, Requirements engineering
\item Exercise 1a: Requirements engineering
\item Exercise 1b: Requirements engineering
...
\subsection{Sprint 2}
In Sprint 2, the group should be up to speed in both engineering and monetizing. Now the monetizing will decrease and the strategizing will increase in its place. The high-level goals of Sprint 2 is to 1) evolve the robot, 2) maintain the customer relationship, and 3) develop a strategy for the LU Rumble.
...
To support Sprint 2, the following sessions are schedueled:
\begin{itemize}
\item Lecture 3:
\item 
\item
...
After Sprint 3, it is important that the SRS, the Final Robot release, the test specification, and the marketing concept are aligned.
