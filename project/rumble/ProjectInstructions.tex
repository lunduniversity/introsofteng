...
\begin{itemize}
\item SRS v0.5 to the regulatory body (Requirements engineer)
\item Robot Alpha release (Development lead)
\item Test specification v0.5 (Test lead)
\item 3 min sales pitch and website (Sales engineer)
\end{itemize}
