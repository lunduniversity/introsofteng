...
\begin{center}
    \begin{tabular}{|c|c|p{8cm}|c|}
        ...
        \hline
        Markus Borg & 2018-03-27 & Replaced test specification with STS. & 0.85\\
        \hline
    \end{tabular}
\end{center}
...
\begin{description}
\item[v0.5] A skeleton of an STS adhering to the provided template. Initial thoughts on how the group will perform testing and general quality assurance shall be documented, in particular regarding unit testing.
\item[v0.9] TBD.
\item[v1.0] TBD.
\end{description}
