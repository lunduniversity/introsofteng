...
Lean canvas (latest version)   & Supervisor          & Project manager           & L3: see time plan \\ \hline
SRS v0.5                       & Customer+ Supervisor & Requirements engineer     & L3: see time plan \\ \hline
Robot Alpha version            & Customer+ Supervisor & Software architect          & L3: see time plan  \\ \hline
STS v0.5        			   & Customer+ Supervisor & Quality engineer                 & L3: see time plan  \\ \hline
Sales pitch + promotion folder & Course responsible  & Sales engineer            & L2: see time plan \textbf{(before Robot Fair!)}\\ \hline
Purchase array                 & ``Grå skåpet''      & Project manager             & L4: see time plan \textbf{(after Robot Fair!)} \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Deliverable}           & \textbf{Receiver}   & \textbf{Responsible role} & \textbf{When?}     \\ \hline
Lean canvas (latest version)   & Supervisor          & Project manager           & L5: see time plan \\ \hline
SRS v0.9                       & Customer+ Supervisor & Requirements engineer    & L5: see time plan \\ \hline
Robot Beta version (MVP)       & Customer+ Supervisor & Software architect         & L5: see time plan  \\ \hline
STS v0.9        			   & Customer+ Supervisor & Quality engineer         & L5: see time plan  \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Deliverable}           & \textbf{Receiver}   & \textbf{Responsible role} & \textbf{When?}     \\ \hline
Lean canvas (final version)   & Supervisor          & Project manager           & L6: see time plan \\ \hline
SRS review protocol            & Supervisor & Requirements engineer     & L6: see time plan \\ \hline
SRS v1.0                       & Customer+ Supervisor & Requirements engineer     & L6: see time plan \\ \hline
Robot Final version        & Customer+ Supervisor & Software architect          & L6: see time plan  \\ \hline
STS v1.0        			   & Customer+ Supervisor & Quality engineer             & L6: see time plan  \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Deliverable}           & \textbf{Receiver}   & \textbf{Responsible role} & \textbf{When?}     \\ \hline
Fixed Robot Market prices   & Robot Market          & Sales engineer           & L7: see time plan \\ \hline
Acceptance test report   & Supervisor          & Project manager           & L7: see time plan \\ \hline
Business claims (optional)                       & Course responsible & Project manager     & L7: see time plan \\ \hline
Purchase orders and team composition       & Course responsible & Project manager         & L8: see time plan  \\ \hline
\end{tabular}
\end{table}
