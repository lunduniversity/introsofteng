...
\begin{table}[]
\centering
\caption{Deliverables due after Sprint 2, i.e., the Beta Release.} %TODO Update dates
\label{tab:sprint2}
\begin{tabular}{|p{4cm}|p{2cm}|p{2.5cm}|p{4.5cm}|}
\hline
\textbf{Deliverable}           & \textbf{Receiver}   & \textbf{Responsible role} & \textbf{When?}     \\ \hline
...
\begin{table}[]
\centering
\caption{Deliverables due after Sprint 3, i.e., the Final Release.} %TODO Update dates
\label{tab:sprint3}
\begin{tabular}{|p{4cm}|p{2cm}|p{2.5cm}|p{4.5cm}|}
\hline
\textbf{Deliverable}           & \textbf{Receiver}   & \textbf{Responsible role} & \textbf{When?}     \\ \hline
