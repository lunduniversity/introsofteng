...
Figure~\ref{fig:market} shows an example of how two project groups purchase robots. After the robot fair, Group A strikes a deal with Group C for \euro55. As Robot C was quite costly, Group A complements it with two cheaper Robot B droids in a \euro38 bundle deal to create a team of three robots for LU Rumble. Robot B resulted from bespoke development for Group C -- and they liked the result enough to buy two additional robots in a bundle deal at the later Robot Market stage. Furthermore, Group C complements the cheap droids by two basic bots: a Basic Leader Bot and a Basic Bot. Both Groups A and C spend \euro93 of their budgets. The remaining \euro7 is counted towards the teams' profits, increasing their chances to win the Most Profitable Team award (see Section~\ref{sec:rumble}).
